...
#ifndef _SK_UTIL_TEST_INSUFFICIENTMEMORYEXCEPTIONTEST_
#define _SK_UTIL_TEST_INSUFFICIENTMEMORYEXCEPTIONTEST_
...
namespace sk {
  namespace util {
    namespace test {
      class InsufficientMemoryExceptionTest
...
#endif /* _SK_UTIL_TEST_INSUFFICIENTMEMORYEXCEPTIONTEST_ */
